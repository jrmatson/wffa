...
<html>
 <head></head>
 <body>
 <h1>Annual Meeting selection details by Item, Choice, and Name</h1>
...
mysqli_query($db, $query) or die('Error building amdetails.');

$query = "select Item, Choice, Name from amdetails order by itemw, choicew, lname";
