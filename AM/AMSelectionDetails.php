...
$filename = 'amlist_byname.csv';
if (file_exists($filename)) {
    unlink($filename);
}

// export data to csv file sorted by desired output 
exec ("mysql --defaults-file=creds2.cfg -B -e 'SELECT Name, Item, Choice, Qty FROM amdetails order by lname, itemw, choicew' > amlist_byname.csv");
...
$mail->addAttachment('amlist_byname.csv');         		// Add attachments
